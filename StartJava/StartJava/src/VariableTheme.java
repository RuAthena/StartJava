public class VariableTheme {
    public static void main(String[] args) {
        ...
        // Задание 7: ASCII-арт Дюка
        System.out.println("1. ASCII-арт Дюка");

        // Создаем переменные для каждого уникального символа
        String backslash = "/";
        String underscore = "_";
        ...
        // Формируем и выводим ASCII-арт
        System.out.println(space + backslash + backslash);
        System.out.println(space + backslash + space + space + backslash);
        System.out.println(space + backslash + underscore + leftParenthesis + rightParenthesis + backslash);
        System.out.println(space + backslash + space + space + space + backslash);
        System.out.println(backslash + underscore + underscore + underscore + backslash + backslash + underscore + backslash + backslash);

        // Пустая строка для разделения задач
        System.out.println();
